...
public class Test
{
  ...
  ArrayList<GlossaryItem> glossaryItems = project1.getGlossary().getAll();

    for (int i=0; i<glossaryItems.size(); i++)

  {

    project3.addGlossaryItem(glossaryItems.get(i).getPhrase(),

        glossaryItems.get(i).getDefinition());
